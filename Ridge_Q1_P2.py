...
plt.figure()
plt.plot(range(np.array(training_error).shape[0]), np.array(training_error),  linewidth = 2, label = 'Training_error')
...
plt.ylabel('Error')
plt.title("Step size=5e-6, lambda=10, Tol=1e-7")
plt.show()
...
# plt.xlabel('Number of iterations')
# plt.ylabel('b')
# plt.title("Step size=5e-6, lambda=10")
# plt.show()
...
plt.xlabel('Number of iterations')
plt.ylabel('Error')
plt.title("Step size=5e-6, lambda=0, Tol=1e-7")
plt.show()
...
# plt.xlabel('Number of iterations')
# plt.ylabel('b')
# plt.title("Step size=5e-6, lambda=0")
# plt.show()
